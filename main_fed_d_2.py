...
def unlearning_train(args, dataset_train, dataset_test, dict_users, unlearning_client_id, unlearning_epoch, client_acc_list, client_loss_list):
    net_glob.train()
...
if __name__ == '__main__':
    ...
    for epoch in range(unlearning_epoch):
        # checkpoint_filename = f'./save/normal_epoch_{epoch}.pt'
        # checkpoint = torch.load(checkpoint_filename)
        # net_glob.load_state_dict(checkpoint['state_dict'])
    ...
    acc_train_with_unlearning, acc_test_with_unlearning, loss_train_with_unlearning, client_acc_with_unlearning, client_loss_with_unlearning = unlearning_train(args, dataset_train, dataset_test, dict_users, unlearning_client_id, unlearning_epoch, client_acc_list, client_loss_list)
