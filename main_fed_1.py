...
if __name__ == '__main__':
    ...
    for iter in range(args.epochs):
        ...
        # 如果某个 client 请求 unlearning，您需要从这里开始处理
        # 假设 unlearning_client_id 是请求 unlearning 的 client 的 ID
        # unlearning_epoch 是请求 unlearning 的 epoch
        # 您需要在这里添加逻辑来处理 unlearning 请求
        # 例如：
        # if iter == unlearning_epoch - 1:
        #     net_glob.eval()
        ...
        # if iter > unlearning_epoch and unlearning_client_id in idxs_users:
        #     idxs_users.remove(unlearning_client_id)
        #     # 加载之前的模型
        #     net_glob.load_state_dict(torch.load('./save/epoch_{}.pt'.format(unlearning_epoch)))
        #     continue  # 跳过这个 client 的训练
